...
class DiffusionUNet(nn.Module):
    ...
    def forward(self, x, t, c_concat: list = None, c_crossattn: list = None, c_class: list = None):
        ...
        elif self.conditioning_key == 'concat_two':
        ...
        elif self.conditioning_key == 'class_concat':
            xc = torch.cat([x] + [c_class[1]], dim=1)
            cc = c_class[0]
            out = self.diffusion_net(xc, t, y=cc)
