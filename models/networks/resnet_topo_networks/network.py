...
class ResNet(nn.Module):
	...
	def __init__(self, block, layers, in_channel, kernel, padding, topo_dim, zero_init_residual=False,
		...
		self.fc_topo = nn.Linear(32*4*4*4, topo_dim)
...
def _resnet(arch, block, layers, in_channel, kernel, padding, topo_dim):
	model = ResNet(block, layers, in_channel, kernel, padding, topo_dim)
