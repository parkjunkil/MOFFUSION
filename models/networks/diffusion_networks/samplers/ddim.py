# Reference: The code has been modified from the repo: https://https://github.com/yccyenchicheng/SDFusion
"""SAMPLING ONLY."""
...
class DDIMSampler(object):
    ...
    def p_sample_ddim(self, x, c, t, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.:
            ...
            warnings.warn("Unconditional conditioning is not considered in this version.", FutureWarning)

        # Unconditional conditioning stuff
        '''
        elif mm_cls_free:
